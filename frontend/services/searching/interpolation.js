...
export const interpolationSearch = async (array, target) => {
    try {
        const response = await fetch(`${API_URL}/search/interpolation`, {
            method: "POST",
            headers: {
        ...
        console.error("Interpolation Search request failed:", error);
        throw error;
    }
};
